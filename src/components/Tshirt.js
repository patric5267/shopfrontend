...
const Tshirt = () => {
  document.title='Ecommerce | T-Shirts'
            ...
            <div className="rightfilter">
              ...
              <div className="parentsort">
                <div className='sort'>
                  ...
                  {
                    state && <>
                      <div style={{ backgroundColor: 'white' , cursor:'pointer' }} onClick={() => definevalue('Rating: Low to High' , 3)}>Rating: Low to High</div>
                      <div style={{ backgroundColor: 'white' , cursor:'pointer' }} onClick={() => definevalue('Rating: High to Low',4)}>Rating: High to Low</div>
                      <div style={{ backgroundColor: 'white' , cursor:'pointer' }} onClick={() => definevalue('Price: High to low' , 2)}>Price: High to low</div>
                      <div style={{ backgroundColor: 'white' , cursor:'pointer' }} onClick={() => definevalue('Price: Low to High' ,1)}>Price: Low to High</div>
                    </>}
                </div>
              </div>
